import { rangeToLspRange, lspRangeToRange } from "./helpers"
...
class GhostCompleter {
    ...
    async apply(completion: InlineCompletionItem) {
        ...
        await this.editor.edit((edit) => edit.replace(replaceRange, insertText as string, InsertTextFormat.Snippet))
